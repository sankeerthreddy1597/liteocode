...
import { type ModeType, type AnyChatModelId } from "@litecode/shared";
...
function SessionChat({
  ...
  session: SessionData;
  initialPrompt?: { message: string; mode: ModeType; model: AnyChatModelId };
}) {
